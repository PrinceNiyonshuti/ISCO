        ...
        <div class="container-fluid">
            ...
            ?>
                <!-- Page Heading -->
                <h1 class="h3 mb-2 text-gray-800"> <?php echo $site_name; ?> Security Shift Assignment</h1>
		                    ...
		                    <tr>
		                        ...
		                        <td>
		                        	<?php
			                            if (empty($shift_id)) {
			                                ?>
		                                        <a href="index.php?shift-assignment&sec_id=<?php echo $sec_id ?>" class="btn btn-primary btn-icon-split btn-sm" >
		                                            <span class="icon text-white-50">
		                                                  <i class="fas fa-plus-square"></i>
		                                            </span>
		                                                <span class="text">Assign Shift</span>
		                                        </a>
		                                    <?php
		                                } else {
		                                    ?>
		                                        <a href="index.php?update-shift-assignment&sec_id=<?php echo $sec_id ?>" class="btn btn-success btn-icon-split btn-sm" >
		                                            <span class="icon text-white-50">
		                                                  <i class="fas fa-history"></i>
		                                            </span>
		                                                <span class="text">Update Shift</span>
		                                        </a>
		                                    <?php
		                                }
			                        ?>
