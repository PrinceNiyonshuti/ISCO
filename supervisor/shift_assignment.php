                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2"><b><?php echo $site_name ?> Shift Assignment</b></h3>
                                        </div>
                                        <hr>
                                        <form action="#/" onsubmit="assign_shift();return false;"  method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-lg-4">
