...
if(empty($gate_name)||empty($site_id)) {
    ...
    else
    {
        ...
        $sql=" INSERT INTO `gate`( `gate_name`, `site_id`, `created_date`) VALUES ('$gate_name','$site_id','$save_date') ";

            if ($conn->query($sql)===TRUE) 
            {
                ?>
                <div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
                    <span class="badge badge-pill badge-success">Done</span> You have succeffuly Created Site Gate.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close" style="" onclick="location.reload();">
                    <span aria-hidden="true">&times;</span>
                    </button>
                    <br>
