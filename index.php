            ...
            <div class="row">
              ...
              <div class="col-lg-6">
                <div class="p-5">
                  ...
                  <p id="Message1"></p>
                  <form class="user" method="post" action="#/" onsubmit="login1();return false;">
                    <div id="alert1"></div>
                    ...
                    <button type="submit" class="btn btn-primary btn-user btn-block"  name="login_btn" >Sign in</button>
                    <hr>
                  </form>
                  <hr>
                  <div class="text-center">
                  ...
                  <div class="text-center">
                    <a class="small" href="attendance.php">Attendance Check</a>
                  </div>
