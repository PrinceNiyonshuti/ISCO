<?php 
        ...
        if(ISSET($_GET['sec_id'])){
            ...
            $sql=" DELETE FROM `assignment_security` WHERE sec_id='$sec_id' ";

            $sql_1="UPDATE security set site_id=NULL where sec_id='$sec_id'";

                if ($conn->query($sql)&&$conn->query($sql_1)===TRUE) 
                {
                    echo '<script language="javascript">
                      alert(" Security Successfully Discarded ");
                      window.location.href = "index.php?security-assignment&site_id='.$site_id.'";
                    </script>';
...
?>
                                ...
                                <div class="col-lg-12">
                                    ...
                                    <div class="card-body">
                                        <div class="card-title">
                                            <h3 class="text-center title-2"><b><?php echo $site_name ?> Security Assignment</b></h3>
                                        </div>
                                        <hr>
                                        <form action="#/" onsubmit="assign_security();return false;"  method="post" novalidate="novalidate">
                                            <div class="row">
                                                <div class="col-lg-4">
                                                    ...
                                                    <div class="input-group">
                                                        <select id="sec_id" name="sec_id" class="form-control cc-cvc">
                                                            ...
                                                            <?php
                                                                ...
                                                                $sql2=" SELECT * FROM security WHERE site_id IS NUll  ";
        ...
        <div class="container-fluid">
                ...
                <div class="card shadow mb-4">
                    <div class="card-body">
                        <div class="card-title">
                            <h4 class="text-center title-2"><b><?php echo $site_name ?> Assigned Security </b></h4>
                        </div>
                      <div class="table-responsive">
                        ...
                        <tbody>
                            <tr>
                                ...
                                <td>
                                    <a href="index.php?security-assignment&site_id=<?php echo $site_id ?>&sec_id=<?php echo $row1['sec_id']; ?>" class="btn btn-danger btn-icon-split btn-sm" >
