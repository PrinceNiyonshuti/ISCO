...
if(empty($site_id)||empty($sec_id)) {
    ...
    else
    {
        ...
        $sql_1="UPDATE security set site_id='' where sec_id='$sec_id'";

            if ($conn->query($sql)&&$conn->query($sql_1)===TRUE) 
            {
                ?>
                <div class="sufee-alert alert with-close alert-success alert-dismissible fade show">
                    <span class="badge badge-pill badge-success">Done</span> You have succeffuly Discarde Site From Security.
                    <button type="button" class="close" data-dismiss="alert" aria-label="Close" style="" onclick="location.reload();">
                    <span aria-hidden="true">&times;</span>
                    </button>
                    <br>
